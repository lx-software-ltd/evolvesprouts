...
| Primary address | Same mailbox as `NEXT_PUBLIC_EMAIL` |
| Contact address (website) | `NEXT_PUBLIC_EMAIL` |
...
The business inbox named by `NEXT_PUBLIC_EMAIL` is used for:
...
| Field | Value | Issue |
|---|---|---|
| Display name | Evolve Sprouts \| founder from `NEXT_PUBLIC_FOUNDER_NAME` | OK |
...
>
> Founded by the Evolve Sprouts founder, AMI Montessori-certified.
>
...
| About | Generic description | Montessori-based helper training and family support for Hong Kong families with children aged 0-6. Founded by the Evolve Sprouts founder, AMI Montessori-certified. |
