...
| `OPENROUTER_MODEL` | OpenRouter model identifier for invoice parsing, Helper Detector, and JSON repair; also sales AI fallback when sales settings cannot be read |
